export const ru = {
    translations: {
        ...
        analyzer: {
            ...
            chosenSafety: "Рейтинг безопасности {{tile}} был {{rating}}. ({{- explanation}}) ",
